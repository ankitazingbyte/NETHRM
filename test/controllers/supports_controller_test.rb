...
class SupportsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create support" do
    assert_difference('Support.count') do
      post supports_url, params: { support: { email: @support.email, name: @support.name, show_in_client: @support.show_in_client } }
    end
  ...
  test "should update support" do
    patch support_url(@support), params: { support: { email: @support.email, name: @support.name, show_in_client: @support.show_in_client } }
