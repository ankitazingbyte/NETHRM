...
class EvaluationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create evaluation" do
    assert_difference('Evaluation.count') do
      post evaluations_url, params: { evaluation: { description: @evaluation.description, title: @evaluation.title } }
    end
  ...
  test "should update evaluation" do
    patch evaluation_url(@evaluation), params: { evaluation: { description: @evaluation.description, title: @evaluation.title } }
